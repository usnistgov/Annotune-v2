...
SECRET_KEY = 'django-insecure-@-qo_5m50rs^5_cw#@bjix)$2%fzb1hg4hd!slarqa_9vhsx9-'
...
MIDDLEWARE = [
    ...
    # 'annotune.middleware.NoCacheMiddleware',
]

ROOT_URLCONF = 'annotune.urls'
...
WSGI_APPLICATION = 'annotune.wsgi.application'
